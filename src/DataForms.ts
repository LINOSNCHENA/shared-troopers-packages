...
//5
export const expenseSample = <IExpense>({
...
//7
export const DummySalary: ISalary = {
...
//8
export const shoppingSample = <IShopping>({
...
//9
export const evaluationSample = <IEvaluation>({
...
// 10
export const profileSample = <IProfile>({
...
//11
export const maximumSample = <IMaximum>({
...
//12
export const sizesForm = <IDataSizes>({
